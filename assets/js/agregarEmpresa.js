function agregarEmpresa(idEmpresa, Nit, nombreEmpresa, direccion){
    ...
    // InputIdEmpresa.appendChild(InputIdEmpresa);
    // InputNit.appendChild(InputNit);
    // InputNombreEmpresa.appendChild(InputNombreEmpresa);
    // InputDireccion.appendChild(InputDireccion);
}