...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 12-08-2021 a las 01:42:57
...
INSERT INTO `detalle` (`idDetalleFactura`, `idProducto`, `idFactura`, `idPedido`, `IdServicio`, `codigoProducto`, `producto`, `cantidad`) VALUES
(1, 1, NULL, 277952570, 1, '', 'locion', 3),
(2, 2, NULL, 277952570, 1, '', 'Silla', 4);
...
(111101, 1, 1006700633, 'Alejandra Perez', '', 'Empresa x', 'CRR', '2021-07-14', 0, 0),
(179821511, 1, 0, 'Aleja ', 'NIT123', 'Empresa1', 'crr', '2021-08-11', 0, 0),
