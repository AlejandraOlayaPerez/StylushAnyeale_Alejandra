...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-07-2021 a las 17:15:27
...
INSERT INTO `pedido` (`idPedido`, `idProducto`, `documentoIdentidad`, `responsablePedido`, `empresa`, `direccion`, `codigoPedido`, `codigoProducto`, `producto`, `cantidad`, `fechaPedido`, `entregaPedido`, `eliminado`) VALUES
(1, NULL, 1006700633, 'Alejandra Perez', 'Empresa x', 'CRR', 'P140721--01', 'V1', 'Locion', 5, '2021-07-14', 0, 0);
