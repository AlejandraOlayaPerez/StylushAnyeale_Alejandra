...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-09-2021 a las 02:06:22
...
(58, 1, NULL, 111101, NULL, NULL, 'll88', 'Loción Tónica Capila', 13, 1.28, 1);
...
(111101, 1, 1006700633, 'Alejandra Perez', 'NIT123', 'Empresa1', 'crr', '2021-09-21', 0, 0),
...
(132436115, 1, 2147483647, 'Alejandra Perez', 'NIT123', 'Empresa1', 'crr', '2021-09-21', 0, 0),
...
(528300964, 'hh8', 'Removedor Semiperman', 'Masglo Plus se convertirá en el aliado perfecto para las mujeres, ya que les dará a sus uñas todo lo que ellas desean, una gran variedad de colores y brillo perfecto por dos semanas*, ideal para combi', 0, 'Línea: Esmalte Semipermanente\r\nFormato del quitaesmalte: Líquido\r\nUnidades por envase: 1\r\nCon acetona: Sí\r\nCantidad: 60\r\nTipo de unidad: mL', '9999.99', 0),
...
(3, 8, 8, 409358848, 'Jimena', 'Olaya', 2147483647, '2021-09-13', '08:00:00', '09:59:00', 0, 0, '', 400.00, 0),
(86300113, 8, NULL, 267687805, 'jimena Perez', 'jimena Perez', 2147483647, '2021-09-13', '19:30:00', '00:00:00', 0, 0, '', 6765.00, 0),
...
(441675660, 5, 1, 409358848, 'Maria ', 'Lopez ', 123456789, '2021-09-05', '10:30:00', '10:59:00', 0, 0, '', 0.00, 0),
...
(115, 363921012, NULL, NULL, 2, 'Ha creado un nuevo pedido', '2021-09-13', '21:20:35'),
(116, 363921012, NULL, NULL, 2, 'Ha validado un pedido', '2021-09-13', '21:21:07'),
(117, NULL, 1, NULL, 2, 'Restar prueba', '2021-09-13', '21:22:39'),
(118, 571370830, NULL, NULL, 2, 'Ha creado un nuevo pedido', '2021-09-13', '21:24:51'),
(119, 571370830, NULL, NULL, 2, 'Ha cancelado un pedido', '2021-09-13', '21:24:58'),
(120, 96510647, NULL, NULL, 2, 'Ha creado un nuevo pedido', '2021-09-13', '21:25:33'),
(121, 594031540, NULL, NULL, 2, 'Ha creado un nuevo pedido', '2021-09-15', '23:00:24'),
(122, 211800008, NULL, NULL, 2, 'Ha creado un nuevo pedido', '2021-09-16', '14:17:44'),
(123, 111101, NULL, NULL, 2, 'Ha modificado un pedido', '2021-09-20', '18:22:41'),
(124, 269095276, NULL, NULL, 2, 'Ha creado un nuevo pedido', '2021-09-20', '20:57:58'),
(125, 307530109, NULL, NULL, 2, 'Ha creado un nuevo pedido', '2021-09-20', '20:59:20'),
(126, 702719052, NULL, NULL, 2, 'Ha creado un nuevo pedido', '2021-09-20', '21:03:14'),
(127, 296492338, NULL, NULL, 2, 'Ha creado un nuevo pedido', '2021-09-20', '21:04:11'),
(128, 132436115, NULL, NULL, 2, 'Ha creado un nuevo pedido', '2021-09-21', '15:28:25');
...
--
ALTER TABLE `detalle`
  MODIFY `idDetalleFactura` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=59;
...
--
ALTER TABLE `seguimiento`
  MODIFY `idSeguimiento` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=129;
