                            ...
                            <div class="bs-stepper">
                                ...
                                <div class="bs-stepper-content">
                                    ...
                                    <div id="logins-part" class="content" role="tabpanel" aria-labelledby="logins-part-trigger">
                                        ...
                                        <div class="row" style="margin: 5px;">
                                            <div class="col-md-6">
                                                ...
                                                <input class="form-control" type="number" name="idPedido" placeholder="CodigoPedido">
                                            </div>
                                            <div class="col-md-6">
                                        ...
                                        <br>
                                        <button class="btn btn-info" onclick="stepper.next()"><i class="fas fa-arrow-circle-right"></i> Siguiente</button>
                                    </div>
                                    ...
                                    <div id="information-part" class="content" role="tabpanel" aria-labelledby="information-part-trigger">
                                        ...
                                        <br>
                                        <button class="btn btn-info" onclick="stepper.previous()"><i class="fas fa-arrow-circle-left"></i> Anterior</button>
                                        <button class="btn btn-success"><i class="fas fa-save" name="funcion" value="nuevoPedido"></i> Guardar</button>
                                    </div>
                                </div>
                            </div>
                        </div>
