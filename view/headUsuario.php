...
<body style="background-color:rgba(255,255,204,255); margin-top:2px;">
    <div class="container">
        ...
        <div>
            <nav class="navbar navbar-expand-lg" style="background-color: rgb(249,201,242); position:relative; bottom:60px; height:auto;">
                <div class="container-fluid" style="background-color: rgb(249,201,242);">
                    <strong><a style="margin-right:5px; margin-left:5px; background-color:rgb(249,201,242); font-family:'Times New Roman', Times, serif; font-weight: bold; font-size:30px; color:black;" class="nav-link active" href=""><i class="fas fa-home"></i> STYLUSH ANYEALE</a></strong>
                    <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
                        <span class="navbar-toggler-icon"></span>
                    </button>
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item"><strong><a style="margin-right:2px; margin-left:2px; background-color:rgb(249,201,242); font-family:'Times New Roman', Times, serif; font-weight: bold; font-size:30px; color:black;" class="nav-link active" aria-current="page" href=""><i class="fas fa-image"></i> Galeria</a></strong></li>
                        <li class="nav-item"><strong><a style="margin-right:2px; margin-left:2px; background-color:rgb(249,201,242); font-family:'Times New Roman', Times, serif; font-weight: bold; font-size:30px; color:black;" class="nav-link active" aria-current="page" href=""><i class="fas fa-wine-bottle"></i> Producto</a></strong></li>
                        <li class="nav-item"><strong><a style="margin-right:2px; margin-left:2px; background-color:rgb(249,201,242); font-family:'Times New Roman', Times, serif; font-weight: bold; font-size:30px; color:black;" class="nav-link active" aria-current="page" href=""><i class="fas fa-cut"></i> Servicios</a></strong></li>
                        <li class="nav-item"><strong><a style="margin-right:2px; margin-left:2px; background-color:rgb(249,201,242); font-family:'Times New Roman', Times, serif; font-weight: bold; font-size:30px; color:black;" class="nav-link active" aria-current="page" href=""><i class="fas fa-clock"></i> Reserva</a></strong></li>
                    </ul>
                </div>
            </nav>
        </div>
