...
<body class="hold-transition sidebar-mini">
    <div class="container-md">
        <div class="card card-solid"  style="margin: 10px;">
            <div class="card-body">
                <div class="row">
                    <div class="col-12 col-sm-6">
                        <h3 class="d-inline-block d-sm-none"><?php echo $oProducto->nombreProducto; ?></h3>
                        <div class="col-12">
                            <img src="../<?php echo $oProducto->fotoProducto1; ?>" class="product-image" alt="Product Image">
                        </div>
                        <div class="col-12 product-image-thumbs">
                            <div class="product-image-thumb"><img src="../<?php echo $oProducto->fotoProducto2; ?>" alt="Product Image"></div>
                            <div class="product-image-thumb"><img src="../<?php echo $oProducto->fotoProducto3; ?>" alt="Product Image"></div>
                            <div class="product-image-thumb"><img src="../<?php echo $oProducto->fotoProducto4; ?>" alt="Product Image"></div>
                            <div class="product-image-thumb"><img src="../<?php echo $oProducto->fotoProducto5; ?>" alt="Product Image"></div>
                        </div>
                    </div>
                    <div class="col-12 col-sm-6">
                        ...
                        <div class="bg-gray py-2 px-3 mt-4">
                            <h2 class="mb-0">Precio: 
                                <?php echo $oProducto->costoProducto; ?>
                            </h2>
                        </div>
