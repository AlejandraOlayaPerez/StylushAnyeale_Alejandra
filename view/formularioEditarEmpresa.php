                        ...
                        <div class="card-body" style="background-color: rgba(255, 255, 204, 255);">
                            <div class="row">
                                <div class="col col-xl-4 col-md-6 col-12">
                                    <label for="">Nit</label>
                                    <input type="text" class="form-control" name="Nit" id="" placeholder="NIT" value="<?php echo $oEmpresa->Nit; ?>">
                                </div>
                                <div class="col col-xl-4 col-md-6 col-12">
                                    <label for="">Nombre Empresa</label>
                                    <input type="text" class="form-control" name="nombreEmpresa" id="" placeholder="Nombre Empresa" value="<?php echo $oEmpresa->nombreEmpresa; ?>">
                                </div>
                                <div class="col col-xl-4 col-md-6 col-12">
                                    <label for="">Direccion</label>
                                    <input type="text" class="form-control" name="direccion" id="" placeholder="Direccion" value="<?php echo $oEmpresa->direccion; ?>">
                                </div>
                            </div>
                        </div>
