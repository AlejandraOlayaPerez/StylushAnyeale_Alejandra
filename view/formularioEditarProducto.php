                                ...
                                <form action="../controller/productoServicioController.php" method="GET" id="formInformacion" novalidate>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <textarea class="form-control" rows="6" type="text" id="descripcion" name="descripcionProducto" placeholder="Describe el producto" onchange="validarCampo(this);" required minlength="10" maxlength="500"><?php echo htmlspecialchars($oProducto->descripcionProducto); ?></textarea>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col col-xl-4 col-md-6 col-12">
                                            ...
                                            <div class="input-group m-b-0">
                                                ...
                                                <input class="form-control" type="text" id="costoProducto" name="costoProducto" placeholder="CostoProducto" value="<?php echo $oProducto->costoProducto; ?>" onkeyup="separadorMilesCuadroTexto(this);" required>
                                            </div>
